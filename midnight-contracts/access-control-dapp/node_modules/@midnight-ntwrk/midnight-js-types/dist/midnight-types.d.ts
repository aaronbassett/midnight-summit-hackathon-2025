import { type Binding, type ContractAddress, type IntentHash, type Proof, type RawTokenType, type SignatureEnabled, type Transaction, type TransactionHash, type TransactionId, type UnprovenTransaction } from '@midnight-ntwrk/ledger-v6';
/**
...
export type ProvingRecipe<TTransaction> = TransactionToProve | BalanceTransactionToProve<TTransaction> | NothingToProve<TTransaction>;
