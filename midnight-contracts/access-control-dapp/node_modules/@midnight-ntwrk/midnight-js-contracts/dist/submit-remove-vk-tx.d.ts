 ...
 */
export declare const submitRemoveVerifierKeyTx: (providers: ContractProviders, contractAddress: ContractAddress, circuitId: ImpureCircuitId) => Promise<FinalizedTxData>;
