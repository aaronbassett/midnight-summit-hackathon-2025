...
import { type FinalizedTxData, type ImpureCircuitId, type VerifierKey } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
export declare const submitInsertVerifierKeyTx: (providers: ContractProviders, contractAddress: ContractAddress, circuitId: ImpureCircuitId, newVk: VerifierKey) => Promise<FinalizedTxData>;
