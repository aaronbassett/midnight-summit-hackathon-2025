 ...
 */
export declare const getUnshieldedBalances: (publicDataProvider: PublicDataProvider, contractAddress: ContractAddress) => Promise<UnshieldedBalances>;
//# sourceMappingURL=get-unshielded-balances.d.ts.map