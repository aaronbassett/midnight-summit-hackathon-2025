 ...
 */
export declare const submitReplaceAuthorityTx: (providers: ContractProviders, contractAddress: ContractAddress) => (newAuthority: SigningKey) => Promise<FinalizedTxData>;
