<!--
Sync Impact Report:
Version: 1.0.0 → 1.1.0 (pragmatic rebalance)
Modified principles:
  - Speed Over Everything → MVP Speed (allow sustainable practices)
  - Local-Only Simplicity → Simple But Scalable (allow DB, proper env config)
  - Demo-Driven Quality → Demo-First Quality (don't sacrifice all quality)
Added sections: None
Removed sections: None
Templates requiring updates:
  ✅ plan-template.md - Constitution Check section already references constitution file dynamically
  ✅ spec-template.md - No constitution-specific references, already aligned with fast iteration
  ✅ tasks-template.md - Already supports optional testing, aligns with hackathon speed focus
Follow-up TODOs: None - all placeholders filled
-->

# redsmith Constitution

**Ship it fast. Build it right enough.**

## Preamble

This is a hackathon data generation service that might become a real project. Speed is critical, but not at the cost of a foundation that needs immediate rewriting. Build the MVP fast with practices that won't embarrass you if this wins and continues. Good enough to ship, good enough to evolve.
...
- README should cover:
  ...
  - How to run the demo
- Code comments for non-obvious decisions ("using SQLite for local dev, easy to migrate to Postgres later").
- No need for architecture docs or API docs unless they help you.

### 5. Linting: Run It, Don't Obsess
...
- **Pragmatism Over Rules**: If a principle slows you down without clear benefit, skip it. Shipping a working demo is the primary goal.
- **Quality When It Matters**: Don't sacrifice practices that prevent having to rewrite everything if this continues past the hackathon.
- **Amendments**: Unlikely needed for a 48-hour sprint, but if the project continues, revisit and update principles as needed.
- **Compliance**: Self-enforced. You're the developer - use judgment.
